        ...
        <main>
        	...
        	<div class="data">
        		<div class="content-data">
        			...
        			<fieldset>
        				...
        				<form action="classDetailLecturerProcess.php" method="POST" enctype="multipart/form-data">
        					<div class="form-details">
        						...
        						<div class="input-box">
        							...
        							<select name="docType" required>
        								...
        								<?php
        								$sqlSelectDocType = "SELECT * FROM doctype WHERE docDecs = 'Lecturer mark required' OR docDecs = 'All marks required'";
        	...
        	<div class="data">
        		<div class="content-data">
        			...
        			<?php
                	//query
        			$sql = "SELECT * FROM document WHERE uploadBy = '".$_SESSION['admin_id']."'";
        			$query = mysqli_query($connection, $sql) or die("not found");
        			$row= mysqli_fetch_array($query);

        			$sqlDocType = "SELECT * FROM doctype WHERE docDecs = 'Lecturer mark required' OR docDecs = 'All marks required'";
        			...
        			<div class="content-data">
        				<table>
        					...
        					while ($rowDocType= mysqli_fetch_array($queryDocType)) {
        						...
        						$sqlCheckDoc = "SELECT * FROM document WHERE docCode = '" . $rowDocType["docCode"] . "' AND uploadBy = '" . $_SESSION['admin_id'] . "'";
        						...
        						<tr>
        							...
        							<td>
        								...
        								<a class="dw" href="classDetailVDD.php?docRemove=<?php echo $getDocID["docID"]; ?>&studID=<?php echo $stud_id ?>">
