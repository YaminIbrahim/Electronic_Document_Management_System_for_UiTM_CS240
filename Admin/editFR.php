    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="editFR.php" class="active">Edit Document</a></li>
            </ul>
            ...
            <div class="titleContentWButton">
                ...
                <h1 class="titleContent">Edit document</h1>
            </div>
                ...
                <div class="content-data">
                    ...
                    <fieldset>
                        ...
                        <?php
                            ...
                            //`docCode`, `docName`, `docFileName`, `docExtension`, `docSize`, `docMark`, `docDecs`
                        ?>
                        
                        <form action="editFRProcess.php" method="POST" enctype="multipart/form-data">
                            <div class="form-details">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" 
                                           name="docName"
                                           value="<?php echo $row['docName']; ?>"
                                           required>
                                </div>

                                <div class="input-box documentUp">
                                ...
                                <div class="input-box">
                                    ...
                                    <select name="docMark" required>
                                        <option value="<?php echo $row['docDecs']; ?>" selected hidden>
                                            <?php echo $row['docDecs']; ?>
                                        </option>
                            ...
                            <div class="button">
                                <input type="submit" value="Save" name="editDoc" id="saveDoc">
                            </div>
                        </form>
                    </fieldset>
