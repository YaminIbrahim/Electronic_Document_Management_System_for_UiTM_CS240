...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="divider" data-text="ADDITIONAL" class="active">Setting & Support</li>

            <!--Nested Setting & Support links-->
            <li class="active">
                <a href="#" class="active"><i class='bx bx-cog icon' class="active" ></i> Profile & Support <i class='bx bx-chevron-right icon-right' ></i></a>

                <!--unlisted list (drop down)-->
                <ul class="side-dropdown">
                    <li><a href="profile.php" class="active"><i class='bx bx-user icon' ></i>Profile</a></li>
    ...
    <section id="content">
        ...
        <nav style="float: right; width:100%">
            ...
            <div class="sessionInfo" style="float:right;">
                    ...
                    <fieldset>
                        ...
                        <form action="addAdminProcess.php" method="POST" enctype="multipart/form-data">
                            <div class="form-details">
                                ...
                                <div class="input-box">
                                    <i class='bx bxs-envelope' ></i>
                                    <span class="details">Ouriginal Email Address</span>

                                    <input type="text" 
                                           name="email"
                                           value="<?php echo $_SESSION['admin_oemail']; ?>" 
                                           required
                                           readonly>
                                </div>
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" 
                                           name="roomNum"
                                           value="<?php echo $_SESSION['admin_roomnum']; ?>" 
                                           required
                                           readonly>
                                </div>
