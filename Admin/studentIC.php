    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="studentIC.php" class="active">...</a></li>
            </ul>
            ...
            <div class="data">
                ...
                $lect_id = $_SESSION['admin_id'];

                //query to select all admin data from database
                $sql = "SELECT * FROM admin WHERE adminID = '".$lect_id."'";
                        ...
                        <form action="addLecturerProcess.php" method="POST" enctype="multipart/form-data">
                            <div class="form-details">
                                ...
                                <div class="input-box">
                                    ...
                                    name="emailOuriginal"
                                    required
                                    value="<?php echo $row["adminOuriginalEmail"]; ?>" 
                                    readonly>
                                </div>
                                ...
                                <div class="input-box">
                                    ...
                                    placeholder=""
                                    name="phoneNum"
                                    value="<?php echo $row["adminPhoneNum"]; ?>" 
                                    required
                                    readonly>
                                </div>
                                ...
                                <div class="input-box">
                                    ...
                                    placeholder=""
                                    name="roomNum"
                                    value="<?php echo $row["adminRoomNum"]; ?>" 
                                    required
                                    readonly>
                                </div>
