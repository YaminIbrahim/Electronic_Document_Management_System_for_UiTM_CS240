...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <!--Add student link-->
            <li><a href="studentIC.php" class="active"><i class='bx bx-group icon' ></i></i>In charge Student</a></li>
    ...
    <section id="content">
        ...
        <main>
            ...
            <!--page title-->
            <h1 class="title">In-charge Students</h1>

            <!--path-->
            <ul class="breadcrumbs">
                <li><a href="studentIC.php">In charge student</a></li>

                <li class="divider"><i class="fa fa-solid fa-angle-right"></i></li>

                <li><a href="studentIC.php" class="active">Student details (Supervise)</a></li>
            </ul>
            ...
            <div class="data">
                <div class="content-data">
                    <div class="titleContentWButton">
                        ...
                        <!--student filter-->
                        <a href="studentICSV.php?studID=<?php echo $data['studID']; ?>" class="active">
                    ...
                    <div class="data">
                        <div class="content-data">
                            ...
                            <fieldset>
                                ...
                                <form action="studentICSVSupervisorProcess.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-details">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <select name="docType" required>
                                                ...
                                                <?php
                                                $sqlSelectDocType = "SELECT * FROM doctype WHERE docDecs = 'Supervisor and examiner marks required' OR docDecs = 'All marks required'";
                                        ...
                                        <input type="text" name="studID" id="studID" value='<?php echo $data["studID"]; ?>' hidden>

                                        <input type="text" name="uploadBy" id="uploadBy" value='<?php echo $_SESSION['admin_id'] ?>' hidden>
                    ...
                    <?php
                    //query
                    $sql = "SELECT * FROM document WHERE uploadBy = '".$data['studID']."'";
                    ...
                    <?php
                    //query
                    $sql = "SELECT * FROM document WHERE uploadBy = '".$data['studSV']."'";
                    $query = mysqli_query($connection, $sql) or die("not found");
                    $row= mysqli_fetch_array($query);
                    ...
                    <div class="content-data">
                        <table>
                            ...
                            while ($rowDocType= mysqli_fetch_array($queryDocType)) {
                                $sqlCheckDoc = "SELECT * FROM document WHERE docCode = '" . $rowDocType["docCode"] . "' AND uploadBy = '" . $data['studSV'] . "'";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="dw" target="_blank" href="studentICSVSupervisorVDD.php?docView=<?php echo $getDocID["docID"]; ?>&studID=<?php echo $stud_id ?>">
                                            <button class="actionBtn">
                                                View
                                            </button>
                                        </a>

                                        <a class="dw" target="_blank" href="studentICSVSupervisorVDD.php?docDw=<?php echo $getDocID["docID"]; ?>&studID=<?php echo $stud_id ?>">
                                            <button class="actionBtn">
                                                Download
                                            </button>
                                        </a>

                                        <a class="dw" href="studentICSVSupervisorVDD.php?docRemove=<?php echo $getDocID["docID"]; ?>&studID=<?php echo $stud_id ?>">
