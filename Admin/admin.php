    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="admin.php" class="active">...</a></li>
            </ul>
            ...
            <div class="titleContentWButton">
                ...
                <h1 class="titleContent">Admin list</h1>

                <!--add document button-->
                <button class="addBtn" onclick="location.href='addAdmin.php'" type="button">
                    Add Admin
                </button>
            </div>
            ...
            <div class="data">
                ...
                <?php
                //SELECT `adminID`, `adminFName`, `adminLName`, `adminEmail`, `adminPassword`, `adminPhoneNum`, `adminRoomNum` FROM `admin` WHERE 1
                ...
                <div class="content-data">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["adminRoomNum"] ?></td>
                        </tr>
                        <?php
                            $count++; 
                            }
