...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <!--Add request link-->
            <li><a href="meetRecord.php" class="active"><i class='bx bxs-conversation icon'></i> Meeting Record </a></li>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                <li><a href="meetRecord.php">Meeting Record</a></li>

                <li class="divider"><i class="fa fa-solid fa-angle-right"></i></li>

                <li><a href="meetRecord.php" class="active">...</a></li>
            </ul>
            ...
            <div class="data">
                ...
                $sql = "SELECT * FROM student WHERE studSV = '".$_SESSION["admin_id"]."' ORDER BY studName ASC";
