	...
	<section id="content">
        ...
        <main>
        	...
        	<ul class="breadcrumbs">
        		...
        		<li><a href="classAddStudent.php" class="active">Add students</a></li>
        	</ul>
        	...
        	<div class="data">
        		<div class="content-data">
        			<div class="titleContentWButton">
        				...
        				<h1 class="titleContent">Add student</h1>
        			...
        			<fieldset>
                        ...
                        <form action="classAddStudentProcess.php" method="POST" enctype="multipart/form-data">
        	...
        	<div class="data">
        		<div class="content-data">
        			...
        			<div class="titleContentWButton">
        				<!--header content for forms and rubics list-->
        				<h1 class="titleContent">Add students using CSV file</h1>
        			...
        			<fieldset>
        				...
        				<form action="classAddStudentCSV.php" method="POST" enctype="multipart/form-data">
        					<div class="form-details">
        						...
        						<div class="input-box">
        							...
        							<input type="text" name="classID" id="classID" value="<?php echo $row['className']." / ".$row['classYear']." / ".$row['classSession'] ?>" readonly>
        						</div>
