...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <!--Add request link-->
            <li><a href="requestSupervise.php" class="active"><i class='bx bx-message-alt-add icon'></i> Request Supervise </a></li>
    ...
    <section id="content">
        ...
        <main>
            <!--page title-->
            <h1 class="title">Request Supervise</h1>

            <!--path-->
            <ul class="breadcrumbs">
                <li><a href="requestSupervise.php">Request supervise</a></li>

                <li class="divider"><i class="fa fa-solid fa-angle-right"></i></li>

                <li><a href="requestSupervise.php.php" class="active">...</a></li>
            </ul>
            ...
            <div class="data">
                    <div class="content-data">
                        <div class="titleContentWButton">
                            ...
                            <h1 class="titleContent">Approved list</h1>                        
                        </div>

                        <?php
                    //query
                        $sql = "SELECT * FROM student WHERE studSV = '".$_SESSION['admin_id']."'";
                ...
                <div class="data">
                    <div class="content-data">
                        <div class="titleContentWButton">
                            <!--header content for forms and rubics list-->
                            <h1 class="titleContent">Pending list</h1>                        
                        </div>

                        <?php
                    //query
                        $sql = "SELECT * FROM student WHERE studSV = '".$_SESSION['admin_id']."1'";
                        $query = mysqli_query($connection, $sql) or die("not found");
                            ...
                            <table>
                                ...
                                while ($rowStud = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo$rowStud["studFYPTitle"] ?></td>
                                        <td>
                                            <a class="dw" href="requestApprove.php?studID=<?php echo $rowStud["studID"]; ?>&studSV=<?php echo $rowStud["studExam"]; ?>">
