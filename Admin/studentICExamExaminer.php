    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="studentIC.php" class="active">Student details (Examine)</a></li>
            </ul>
            ...
            <div class="data">
                <div class="content-data">
                    <div class="titleContentWButton">
                        ...
                        <!--supervisor filter-->
                        <a href="studentICExamExaminer.php?studID=<?php echo $data['studID']; ?>" class="active">
                        ...
                        <!--student filter-->
                        <a href="studentICExam.php?studID=<?php echo $data['studID']; ?>" class="active">
                    ...
                    <div class="data">
                        <div class="content-data">
                            ...
                            <fieldset>
                                ...
                                <form action="studentICExamExaminerProcess.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-details">
                        ...
                        <table>
                            ...
                            while ($rowDocType= mysqli_fetch_array($queryDocType)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="dw" target="_blank" href="studentICExamExaminerVDD.php?docView=<?php echo $getDocID["docID"]; ?>&studID=<?php echo $stud_id ?>">
                                            <button class="actionBtn">
                                                View
                                            </button>
                                        </a>

                                        <a class="dw" target="_blank" href="studentICExamExaminerVDD.php?docDw=<?php echo $getDocID["docID"]; ?>&studID=<?php echo $stud_id ?>">
                                            <button class="actionBtn">
                                                Download
                                            </button>
                                        </a>

                                        <a class="dw" href="studentICExamExaminerVDD.php?docRemove=<?php echo $getDocID["docID"]; ?>&studID=<?php echo $stud_id ?>">
