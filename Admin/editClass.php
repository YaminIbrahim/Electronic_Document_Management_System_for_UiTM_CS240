    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="addClass.php" class="active">Edit class detail</a></li>
            </ul>
            ...
            <div class="titleContentWButton">
                ...
                <h1 class="titleContent">Edit class detail</h1>
            </div>
                ...
                <div class="content-data">
                    ...
                    <fieldset>
                        ...
                        <form action="editClassProcess.php" method="POST" enctype="multipart/form-data">
                            <div class="form-details">
                                ...
                                <div class="input-box">
                                    ...
                                    <select name="classSession" required>
                                        <option value="" disabled selected hidden>Select class session</option>
                            ...
                            <div class="button">
                                <input type="submit" value="Save" name="editClass" id="editClass">
                            </div>
                        </form>
                    </fieldset>
