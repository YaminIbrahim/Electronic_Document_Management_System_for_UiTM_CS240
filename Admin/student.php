    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                <li><a href="student.php">Record</a></li>
            ...
            <div class="data">
                ...
                <div class="content-data">
                    <div class="titleContentWButton">
                        <!--header content for forms and rubrics list-->
                    ...
                    <table>
                        ...
                        $sqlStudents = "SELECT * FROM student WHERE classID = '$className'";
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["studSV"] ?></td>
                            <td><?php echo $row["studExam"] ?></td>
                            <td><?php echo $row["classID"] ?></td>
                            <td>
                                <a href="studentDetail.php?studID=<?php echo $row["studID"] ?>">
