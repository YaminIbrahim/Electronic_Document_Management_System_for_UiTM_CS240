                    ...
                    <div class="content-data">
                        <table>
                            ...
                            while ($rowDocType= mysqli_fetch_array($queryDocType)) {
                                $sqlCheckDoc = "SELECT * FROM document WHERE docCode = '" . $rowDocType["docCode"] . "' AND uploadBy = '" . $data['studID'] . "'";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="dw" target="_blank" href="classDstudentICSVSupervisorVDDetailVDD.php?docView=<?php echo $getDocID["docID"]; ?>&studID=<?php echo $stud_id ?>">
