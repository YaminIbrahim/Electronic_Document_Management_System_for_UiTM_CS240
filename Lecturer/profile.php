                        ...
                        <form action="addAdminProcess.php" method="POST" enctype="multipart/form-data">
                            <div class="form-details">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" 
                                           name="staffID"
                                           value="<?php echo $_SESSION["lect_id"]; ?>" 
                                           required
                                           readonly>
                                </div>
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" 
                                           name="fName"
                                           value="<?php echo $_SESSION['lect_name']; ?>" 
                                           required
                                           readonly>
                                </div>
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" 
                                           name="email"
                                           value="<?php echo $_SESSION['lect_email']; ?>" 
                                           required
                                           readonly>
                                </div>
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" 
                                           name="email"
                                           value="<?php echo $_SESSION['lect_oemail']; ?>" 
                                           required
                                           readonly>
                                </div>
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" 
                                           name="roomNum"
                                           value="<?php echo $_SESSION['lect_roomnum']; ?>" 
                                           required
                                           readonly>
                                </div>
