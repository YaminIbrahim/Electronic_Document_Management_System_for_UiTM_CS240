...
<body>
	...
	if(isset($_POST['uploadDoc'])){  
	    ...
	    if(move_uploaded_file($file_loc,$folder.$final_file)){
	    	...
	    	$sql = "INSERT INTO `document`(`docName`, `docExtension`, `docSize`, `uploadBy`, `docCode`, `studID`) VALUES ('".$final_file."','".$file_type."','".$file_size."','".$doc_uploadBy."','".$doc_id."','".$stud_id."')";

	    	mysqli_query($connection,$sql);
	  
	        echo "File sucessfully upload";

	        header("location: docSubmit.php?studID=".urlencode($stud_id));
	        exit();
